// [TEST MODE] Copia di stripe-webhook con credenziali Stripe TEST.
// Usa STRIPE_SECRET_KEY_TEST e STRIPE_WEBHOOK_SECRET_TEST.
// Elimina quando il test è completato.
...
async function upsertSubscription(sub: Stripe.Subscription) {
  ...
  if (unitAmount != null) {
    ...
    else monthlyAmountCents = unitAmount;
  }
  ...
  // Non dipendiamo da ON CONFLICT / unique index per la sincronizzazione.

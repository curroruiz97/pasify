      ...
      >
        ...
        <SheetHeader className="pb-4">
          <SheetTitle className="flex items-center justify-center gap-2 text-xl">
            ...
            {t("citySelector.title") || "Selecciona ciudad"}
          </SheetTitle>
        </SheetHeader>

        {isPartner ? (
          <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 text-sm text-amber-800">
            <p>{t("citySelector.partnerNote") || "Los partners no pueden cambiar de ciudad. Contacta con soporte si necesitas actualizar tu ubicación."}</p>
          </div>
        ) : (
          <>
            {/* Country Flags Row */}
            ...
            <div className="relative mb-4">
              ...
              <Input
                type="text"
                placeholder={t("citySelector.searchPlaceholder") || "Buscar ciudad..."}
                value={searchQuery}
            ...
            <div className="flex-1 overflow-y-auto space-y-2 -mx-1 px-1">
              ...
              {filteredCities.length === 0 && (
                <div className="text-center py-12 text-gray-500">
                  ...
                  <p className="text-lg">{t("citySelector.noResults") || "No se encontraron ciudades"}</p>
                </div>
              )}
            </div>
          </>
